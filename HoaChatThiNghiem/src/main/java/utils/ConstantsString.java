...
public class ConstantsString {
    ...
    public static final String FACEBOOK_APP_ID = "1572977559871866";
    public static final String FACEBOOK_APP_SECRET = "32d5f3287e8625be35aceabba0265481";
    ...
    public static final String GOOGLE_REDIRECT_URI = "https://localhost:8080/it-nlu/GoogleLoginServlet";
